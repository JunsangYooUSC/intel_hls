...
sin_fixed(ac_fixed<W, I, S> x){
  ACINT_STATIC_ASSERT( (S && I == 3) || ( (!S) && I == 1) );
  ACINT_STATIC_ASSERT(W <= 64);
...
sinpi_fixed(ac_fixed<W, I, S> x){
  ACINT_STATIC_ASSERT(I >= 0);
  ACINT_STATIC_ASSERT(W - I >= 4);
  ACINT_STATIC_ASSERT(W <= 32);
...
exp_fixed(ac_fixed<W, I, S> x){
  ACINT_STATIC_ASSERT(S);
  ACINT_STATIC_ASSERT(I >= 2);
  ACINT_STATIC_ASSERT(W - I >= 2);
  ACINT_STATIC_ASSERT(W <= 32);
